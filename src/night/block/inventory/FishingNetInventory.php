...
use night\libraries\inventory\TranslatableEntityInventory;
...
class FishingNetInventory extends TranslatableEntityInventory implements ListenerInventory
{
    ...
    public function __construct()
    {
        ...
        ($lock = VanillaItems::WHEAT()->setCustomName('§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r'))->getNamedTag()->setByte('lock', 1);
        $this->setItem(7, $lock);
    ...
    public function sendActor(Player $who): void
    {
        ...
        $properties->setString(EntityMetadataProperties::NAMETAG, 'Fishing Net§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r§r');
