...
use night\libraries\vanilla\block\component\DisplayNameComponent;
...
trait BlockComponentsTrait {
	...
	protected function initComponent(string $texture, bool $useGeometry = true): void {
		...
		if($this->hasEntityCollision()){	
			$this->addComponent((new CollisionBoxComponent())->addBox(new Box(new Vector3(-8, 0, -8), new Vector3(16, 16, 16))));
		}
