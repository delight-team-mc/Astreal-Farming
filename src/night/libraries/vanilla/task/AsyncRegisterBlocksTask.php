...
namespace night\libraries\vanilla\task;

use night\libraries\vanilla\block\BlockFactory;
use NonThreadSafeClass;
...
final class AsyncRegisterBlocksTask extends AsyncTask
{
	...
	public function onRun(): void
	{
		foreach ($this->blockFuncs as $identifier => $blockFunc) {
			BlockFactory::getInstance()->registerBlock($blockFunc, $identifier, serializer: $this->serializer[$identifier], deserializer: $this->deserializer[$identifier]);
		}
	}
}
