...
class TestCmd extends BaseCommand
{
    ...
    {
        if (!$sender instanceof Player) return $sender->sendMessage(TranslateMessage::create('command.error.only_in_game'));
