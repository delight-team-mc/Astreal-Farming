...
class ItemArmorSimple extends Armor implements ItemComponents
{
    ...
    {
        if (!\in_array($this->behavior->getRawComponent('minecraft:wearable.slot', ''), [WearableComponent::SLOT_ARMOR_HEAD, WearableComponent::SLOT_ARMOR_CHEST, WearableComponent::SLOT_ARMOR_LEGS, WearableComponent::SLOT_ARMOR_FEET])) return ItemUseResult::NONE();
