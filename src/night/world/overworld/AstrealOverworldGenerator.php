...
namespace night\world\overworld;

use night\world\decorator\rules\TreeRule;
use night\world\decorator\StructureDecorator;
use night\world\decorator\types\StructureDecoration;
use night\world\overworld\populator\AstrealOverworldPopulator;
 ...
 */
class AstrealOverworldGenerator extends VanillaGenerator
{
    ...
    public function __construct(int $seed, string $preset_string)
    {
        ...
        $deco = new StructureDecorator();
        $deco->setAmount(2);
        $deco->setStructures(...[
            new StructureDecoration('empty', new TreeRule([]), 50),
            new StructureDecoration('battle_tower.mcstructure', new TreeRule([BlockTypeIds::GRASS, BlockTypeIds::DIRT, BlockTypeIds::FARMLAND, BlockTypeIds::SAND]), 1),
            new StructureDecoration('broken_conduit.mcstructure', new TreeRule([BlockTypeIds::GRASS, BlockTypeIds::DIRT, BlockTypeIds::FARMLAND, BlockTypeIds::SAND]), 1),
            new StructureDecoration('desert_palm_tree.mcstructure', new TreeRule([BlockTypeIds::SAND]), 1),
        ]);
        $this->addPopulators($deco, new AstrealOverworldPopulator(), new SnowPopulator());
    }
...
AstrealOverworldGenerator::init();
