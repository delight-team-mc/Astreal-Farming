...
namespace night\world\overworld\populator\biome;
...
class ForestPopulator extends BiomePopulator
{
	...
	protected static function intStructures(): void
	{
		self::$STRUCTURES = [
			new StructureDecoration('puar_oak_tree_3.mcstructure', new TreeRule([BlockTypeIds::GRASS, BlockTypeIds::DIRT, BlockTypeIds::FARMLAND]), 4)
		];
	}
	...
	protected function initPopulators(): void
	{
		...
		$this->structure_decorator->setStructures(...self::$STRUCTURES);
		$this->structure_decorator->setAmount(5);
	}
