...
class BiomePopulator implements Populator
{
	...
	protected StructureDecorator $structure_decorator;
	...
	public function __construct()
	{
		...
		$this->structure_decorator = new StructureDecorator();
	...
	protected function initPopulators(): void
	{
		...
		$this->structure_decorator->setAmount(1);
	}
