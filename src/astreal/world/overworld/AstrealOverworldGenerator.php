...
namespace astreal\world\overworld;

use astreal\world\decorator\rules\TreeRule;
use astreal\world\decorator\StructureDecorator;
use astreal\world\decorator\types\StructureDecoration;
use astreal\world\overworld\populator\AstrealOverworldPopulator;
...
class AstrealOverworldGenerator extends VanillaGenerator
{
    ...
    public function __construct(int $seed, string $preset_string)
    {
        ...
        $deco->setStructures(...[
            ...
            new StructureDecoration('desert_palm_tree.mcstructure', new TreeRule([BlockTypeIds::GRASS, BlockTypeIds::DIRT, BlockTypeIds::FARMLAND, BlockTypeIds::SAND]), 1),
        ]);
